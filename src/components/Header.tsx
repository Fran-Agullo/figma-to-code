...
export function Header() {
  ...
  return <>
      ...
      ease: 'easeOut'
        ...
        <div className="backdrop-blur-x0,5 bg-white/40 border-white/20 shadow-lg shadow-black/5 box-border flex items-center justify-between px-[50px] py-[7px] rounded-[150px] w-full border-0">
