...
export function Header() {
  ...
  return <>
      ...
      ease: 'easeOut'
        ...
        <div className="backdrop-blur-xl bg-white/70 border border-white/20 shadow-lg shadow-black/5 box-border flex items-center justify-between px-6 sm:px-8 md:px-12 py-[7px] rounded-[150px] w-full max-w-[1400px] mx-auto">
          ...
          <div className="box-border content-stretch flex items-center px-0 py-[8px] relative shrink-0">
            <Link to="/">
              ...
              scale: 1.05
            }} className="flex items-center" aria-label="BirdieAgency - Página principal">
                <img src={birdieLogo} alt="BirdieAgency" className="h-[40px] w-auto object-scale-down" />
              </motion.div>
            </Link>
          </div>
          ...
          <div className="flex items-center justify-end gap-2 flex-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/contacto" className="hidden sm:flex">
                ...
                scale: 0.95
              }} className="box-border content-stretch flex items-center justify-center min-h-[50px] pb-[15.5px] pt-[14.5px] px-[22px] relative rounded-[100px] shrink-0" aria-label="Ir a página de contacto">
              ...
              {/* Mobile Menu Button */}
              <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="lg:hidden box-border content-stretch flex items-center justify-center p-3 relative shrink-0 hover:bg-[rgba(234,88,12,0.08)] rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#EA580C] focus:ring-offset-2" aria-label={isMenuOpen ? "Cerrar menú de navegación" : "Abrir menú de navegación"} aria-expanded={isMenuOpen} aria-controls="mobile-menu">
                {isMenuOpen ? <X className="w-6 h-6 text-[#030711]" aria-hidden="true" /> : <Menu className="w-6 h-6 text-[#030711]" aria-hidden="true" />}
              </button>
      ...
      <AnimatePresence>
        ...
        duration: 0.2
      }} className="lg:hidden fixed top-[100px] z-40 flex justify-center px-4 w-full" id="mobile-menu" role="navigation" aria-label="Menú de navegación móvil">
