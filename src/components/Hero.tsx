...
export function Hero() {
  return <section className="relative pt-32 pb-20 px-6 lg:px-12 overflow-hidden" aria-labelledby="hero-heading">
      ...
      repeat: Infinity,
      ease: 'easeInOut'
    }} className="absolute top-20 right-10 w-64 h-64 bg-orange-100 rounded-full blur-3xl opacity-30" aria-hidden="true" />
      <motion.div animate={{
      y: [0, 20, 0],
      rotate: [0, -5, 0]
    }} transition={{
      ...
      repeat: Infinity,
      ease: 'easeInOut'
    }} className="absolute bottom-20 left-10 w-80 h-80 bg-purple-100 rounded-full blur-3xl opacity-20" aria-hidden="true" />
      ...
      <div className="relative max-w-[1440px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          ease: 'easeOut'
            ...
            delay: 0.2,
            duration: 0.6
          }} className="inline-flex items-center gap-2 bg-orange-50 px-4 py-2 rounded-full border border-orange-100" role="text">
            ...
            duration: 0.6
              ...
              <Link to="/portfolio">
                ...
                scale: 0.95
              }} className="border-2 border-[#e5e7eb] text-[#030711] px-8 py-4 rounded-full hover:border-[#EA580C] hover:text-[#EA580C] transition-all focus:outline-none focus:ring-2 focus:ring-[#EA580C] focus:ring-offset-2" aria-label="Ver nuestro portfolio de casos de éxito">
                  Ver casos de éxito
                </motion.button>
              </Link>
            </motion.div>
            ...
            delay: 0.8,
            duration: 0.6
          }} role="list" aria-label="Estadísticas de BirdieDigital" className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200 px-[17px]">
              <div role="listitem">
