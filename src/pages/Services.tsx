              ...
              duration: 0.6
                  ...
                  <div className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-dense' : ''}`}>
                    ...
                    <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                      ...
                      <h2 className="text-4xl md:text-5xl text-[#030711] font-bold mb-6">
                        {service.title}
                      </h2>
                      <p className="text-lg text-[#030711] mb-8 leading-relaxed">
                        {service.description}
                      </p>

                      {/* Benefits */}
                      <div className="mb-8">
                        <h3 className="text-2xl text-[#030711] font-semibold mb-4">
                          Beneficios Clave
                        </h3>
                    ...
                    <div className={index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}>
                      <div className="bg-white p-8 rounded-3xl shadow-lg">
                        <h3 className="text-2xl text-[#030711] font-semibold mb-6">
                          Nuestro Proceso
                        </h3>
                        <div className="space-y-6">
                          {service.process.map((step, idx) => <div key={idx} className="flex gap-4">
                              ...
                              <div>
                                <h4 className="text-lg font-semibold text-[#030711] mb-2">
                                  {step.step}
                                </h4>
