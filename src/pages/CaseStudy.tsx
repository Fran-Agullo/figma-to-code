...
const CaseStudy = () => {
  ...
  return <div className="min-h-screen bg-white font-['Manrope',sans-serif]" lang="es">
      ...
      <main>
        ...
        <section className="py-0 px-6 lg:px-12">
          <div className="max-w-[1200px] mx-auto">
            ...
            duration: 0.6
              ...
              <img src={caseStudy.images?.hero || caseStudy.image} alt={caseStudy.title} className="w-full h-[500px] object-cover" />
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-[900px] mx-auto space-y-16">
            ...
            duration: 0.6
              ...
              <div className="space-y-4">
                {caseStudy.results.map((result, index) => <div key={index} className="flex items-start gap-4">
            ...
            {/* Testimonial */}
            {caseStudy.testimonial && <motion.div initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
        ...
        {/* Related Cases */}
        {relatedCases.length > 0 && <section className="py-24 px-6 lg:px-12 bg-gray-50">
            <div className="max-w-[1440px] mx-auto">
              <h2 className="text-4xl text-[#030711] font-bold mb-12 text-center">
                Más Casos de Éxito
              </h2>
              <div className="grid md:grid-cols-3 gap-8">
                {relatedCases.map((project, index) => <motion.div key={project.id} initial={{
              opacity: 0,
              y: 30
            }} whileInView={{
              opacity: 1,
